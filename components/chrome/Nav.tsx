    ...
    <>
      ...
      <header
        className={`fixed inset-x-0 top-0 z-50 transition-[background-color,border-color,backdrop-filter] duration-[var(--dur-base)] ease-[var(--ease-apple)] ${
          stuck || open
            ? "border-b border-[var(--stage-line)] bg-[color-mix(in_srgb,var(--page-bg)_78%,transparent)] backdrop-blur-xl backdrop-saturate-150"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            style={{ background: "var(--page-bg)", color: "var(--stage-fg)" }}
          >
